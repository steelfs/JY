...
public class Net_TestBase : NetworkBehaviour
{
    ...
    protected virtual void OnEnable()
    {
        ...
        inputActions.Test.LClick.performed += LeftClick;
    }
    ...
    protected virtual void RClick(UnityEngine.InputSystem.InputAction.CallbackContext context)
    {
